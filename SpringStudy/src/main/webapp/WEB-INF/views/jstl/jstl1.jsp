...
<body>
	...
	<p>${productList[3].id}, ${productList[3].name}, ${productList[3].price}</p>
	<p>${productList[4].id}, ${productList[4].name}, ${productList[4].price}</p>
	
	<!-- arr.map(()=>{}) -->
	
	<c:forEach var="i" begin="1" end="5" step="1">
		<p>forEach 반복문 내부 ${i}</p>
		<p>${productList[i-1].id}, ${productList[i-1].name}, ${productList[i-1].price} </p>
	</c:forEach>
