...
<body>
	...
	<form action="/admin/modifyUser" method="post">
		...
		<p>사용자 아이디 : <input type="text" value="${user.id}" disabled></p>
		
		<p>사용자 이름 : <input type="text" name="name" value="${user.name}"></p>
		<p>사용자 비밀번호 : <input name="pw" type="password" value="${user.pw}"></p>
